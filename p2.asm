...
MAIN PROC
    ...
    INT 21H            ; Call DOS interrupt
    MOV BL, AL         ; Store first number in BH
    ...
    MOV AH, 1          ; DOS function: Read character
    INT 21H            ; Call DOS interrupt
    MOV CL, AL         ; Store second number in CH
    ...
    SUB BL, 30H        ; Convert first number from ASCII to integer
    SUB CL, 30H        ; Convert second number from ASCII to integer
